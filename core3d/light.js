...
export function createSun({ color = 0xffffff, intensity = Math.PI * 1.5, target, pos = [15, 50, 50], mapSize = 1024, r = 1, transparent = false, planetColor = 0xFCE570, addLight = true, file } = {}) {
